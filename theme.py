...
def get_colors(specify=False):
    ...
    """
    if specify==False:
        current_theme = settings.get_setting("theme","default")
    else:
        current_theme = specify.lower()
    if current_theme == "default": return{"button_color":"gray10","frame_color":"gray16","root_color":"gray10","hover_color":"#ffffff"}
